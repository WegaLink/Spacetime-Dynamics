...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="RTC" URI="http://resources/4.1.14/app/RTC/0" description="Provides timing and alarm functions using RTC in the calendar time format." version="4.1.14" minDaveVersion="4.0.0" instanceLabel="RTC_0" appLabel="" containingProxySignal="true">
  ...
  <requiredApps URI="http://resources/4.1.14/app/RTC/0/appres_global_scu" requiredAppName="GLOBAL_SCU_XMC4" requiringMode="SHARABLE">
    <downwardMapList xsi:type="ResourceModel:App" href="../../GLOBAL_SCU_XMC4/v4_1_12/GLOBAL_SCU_XMC4_0.app#/"/>
  </requiredApps>
  ...
  <connections URI="http://resources/4.1.14/app/RTC/0/http://resources/4.1.14/app/RTC/0/vs_gcu_intrtctick_int/http://resources/4.1.14/app/RTC/0/vs_global_scu_xmc4_node" systemDefined="true" sourceSignal="event_timer" targetSignal="sr_irq0" srcVirtualSignal="//@virtualSignals.0" proxyTargetVirtualSignalUri="http://resources/4.1.12/app/GLOBAL_SCU_XMC4/0/vs_nvic_signal_in" containingProxySignal="true">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../GLOBAL_SCU_XMC4/v4_1_12/GLOBAL_SCU_XMC4_0.app#//@virtualSignals.0"/>
    <targetVirtualSignal href="../../GLOBAL_SCU_XMC4/v4_1_12/GLOBAL_SCU_XMC4_0.app#//@virtualSignals.0"/>
  </connections>
  <connections URI="http://resources/4.1.14/app/RTC/0/http://resources/4.1.14/app/RTC/0/vs_gcu_intrtcalarm_int/http://resources/4.1.14/app/RTC/0/vs_global_scu_xmc4_node" systemDefined="true" sourceSignal="event_alarm" targetSignal="sr_irq0" required="false" srcVirtualSignal="//@virtualSignals.1" containingProxySignal="true">
    <targetVirtualSignal href="../../GLOBAL_SCU_XMC4/v4_1_12/GLOBAL_SCU_XMC4_0.app#//@virtualSignals.0"/>
  </connections>
</ResourceModel:App>
