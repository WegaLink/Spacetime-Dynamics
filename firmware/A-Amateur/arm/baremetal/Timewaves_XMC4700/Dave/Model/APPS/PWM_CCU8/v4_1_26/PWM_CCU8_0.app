...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM_CCU8" URI="http://resources/4.1.26/app/PWM_CCU8/0" description="PWM APP using one timer slice of CCU8, with external events and dead time support, to generate up to 4 PWM outputs." mode="NOTSHARABLE" version="4.1.26" minDaveVersion="4.3.2" instanceLabel="PWM_CCU8_0" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="event_period_match" URI="http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_period_match_interrupt" hwSignal="pmus_omds" hwResource="//@hwResources.0" visible="true"/>
  ...
  <virtualSignals name="pwm_ch2_direct" URI="http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_ch2_out_a" hwSignal="out2" hwResource="//@hwResources.0"/>
  <virtualSignals name="pwm_ch2_inverted" URI="http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_ch2_out_b" hwSignal="out3" hwResource="//@hwResources.0"/>
  ...
  <hwResources name="PWM_CCU8 CH1 Invert Out" URI="http://resources/4.1.26/app/PWM_CCU8/0/__pin_hwres_port_ch1_out1" resourceGroupUri="devicepackage/0/105" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.1.26/app/PWM_CCU8/0/http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_period_match_interrupt/http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/vs_ccu4_cc4_gp0_unsync" sourceSignal="event_period_match" targetSignal="in0" srcVirtualSignal="//@virtualSignals.1">
