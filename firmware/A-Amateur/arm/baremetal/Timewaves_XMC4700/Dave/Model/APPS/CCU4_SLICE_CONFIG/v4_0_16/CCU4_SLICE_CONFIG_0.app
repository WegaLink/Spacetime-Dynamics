...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CCU4_SLICE_CONFIG" URI="http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0" description="The CCU4_SLICE_CONFIG configures and initializes a CCU4 timer slice.&#xA;The Capture/Compare Unit 4 (CCU4) is a major component for systems that need general purpose timers for signal monitoring/conditioning and Pulse Width Modulation (PWM) signal generation." mode="NOTSHARABLE" version="4.0.16" minDaveVersion="4.3.2" instanceLabel="CCU4_SLICE_CONFIG_DIRECT" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="event_period_match" URI="http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/vs_ccu4_cc4_period_match_interrupt" hwSignal="pmus_omds" hwResource="//@hwResources.0" required="false"/>
  ...
  <virtualSignals name="event_in0" URI="http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/vs_event0_interrupt" hwSignal="e0as" hwResource="//@hwResources.0" visible="true"/>
  <virtualSignals name="event_in1" URI="http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/vs_event1_interrupt" hwSignal="e1as" hwResource="//@hwResources.0" visible="true"/>
  ...
  <virtualSignals name="in0" URI="http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/vs_ccu4_cc4_gp0_unsync" hwSignal="gp0_unsync" hwResource="//@hwResources.0" visible="true">
    <upwardMapList xsi:type="ResourceModel:Connections" href="../../PWM_CCU8/v4_1_26/PWM_CCU8_0.app#//@connections.16"/>
  </virtualSignals>
  ...
  <connections URI="http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/vs_event1_interrupt/http://resources/4.0.8/app/INTERRUPT/2/vs_nvic_signal_in" sourceSignal="event_in1" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.4">
  ...
  <connections URI="http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/vs_event0_interrupt/http://resources/4.0.8/app/INTERRUPT/1/vs_nvic_signal_in" sourceSignal="event_in0" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.3">
