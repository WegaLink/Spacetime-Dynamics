...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="DIGITAL_IO" URI="http://resources/4.0.16/app/DIGITAL_IO/0" description="The DIGITAL_IO APP is used to configure &#xA; a port pin as digital Input/Output." mode="NOTSHARABLE" version="4.0.16" minDaveVersion="4.0.0" instanceLabel="DIGITAL_IN_422" appLabel="">
  ...
  <hwResources name="pin" URI="http://resources/4.0.16/app/DIGITAL_IO/0/__pin_hwres_port_pin" resourceGroupUri="devicepackage/0/59" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.0.16/app/DIGITAL_IO/0/http://resources/4.0.16/app/DIGITAL_IO/0/vs_digital_io_pad_pin/http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/vs_ccu4_cc4_gp1_unsync" sourceSignal="pin" targetSignal="in1" srcVirtualSignal="//@virtualSignals.1">
  ...
  <connections URI="http://resources/4.0.16/app/DIGITAL_IO/0/http://resources/4.0.16/app/DIGITAL_IO/0/vs_digital_io_pad_pin/http://resources/4.0.16/app/CCU4_SLICE_CONFIG/0/vs_ccu4_cc4_gp2_unsync" sourceSignal="pin" targetSignal="in2" srcVirtualSignal="//@virtualSignals.1">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="../../CCU4_SLICE_CONFIG/v4_0_16/CCU4_SLICE_CONFIG_0.app#//@virtualSignals.11"/>
    <targetVirtualSignal href="../../CCU4_SLICE_CONFIG/v4_0_16/CCU4_SLICE_CONFIG_0.app#//@virtualSignals.11"/>
  </connections>
</ResourceModel:App>
